...
xplot = mpfuPh{IEXP};
for ich = 1:2
    plot(xplot - (ich - 2)*5.5, y1fin{IEXP}{ich}, 'o-')
...
yline(pi/2)
xlim(setaxlim(xplot, 1))
labelaxesfig(tL, ['TM xepr phase / %'], "TM Phase / a.u.")
